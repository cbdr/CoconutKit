...
{
    hls_setAssociatedObject(self, s_bindKeyPath, bindKeyPath, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
{
    hls_setAssociatedObject(self, s_bindTransformerKey, bindTransformer, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
